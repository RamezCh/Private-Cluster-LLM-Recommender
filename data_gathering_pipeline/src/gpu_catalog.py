...
GPU_CATALOG: Dict[str, GPUConfig] = {
    ...
    "k80_12gb": GPUConfig("Tesla K80 12GB", 12, "legacy", False, False, 300, 40, False, "bht"),
    ...
    "macbook_pro_m3_max": GPUConfig("MacBook Pro M3 Max", 128, "laptop", False, False, 92, 300, False, "general"),
    "macbook_pro_m2_max": GPUConfig("MacBook Pro M2 Max", 96, "laptop", False, False, 86, 270, False, "general"),
    "macbook_pro_m3_pro": GPUConfig("MacBook Pro M3 Pro", 36, "laptop", False, False, 70, 180, False, "general"),
    "macbook_pro_m2_pro": GPUConfig("MacBook Pro M2 Pro", 36, "laptop", False, False, 65, 150, False, "general"),
    "macbook_pro_m3": GPUConfig("MacBook Pro M3", 24, "laptop", False, False, 60, 120, False, "general"),
    "laptop_integrated": GPUConfig("Integrated GPU", 4, "laptop", False, False, 30, 20, False, "general"),
}
...
BHT_CLUSTER_GPUS: Dict[str, Dict] = {
    "a100_40gb": {"label": "a100", "vram": "40GB", "best_for": "Large models, long contexts"},
    "a100_80gb": {"label": "a100", "vram": "80GB", "best_for": "Very large models"},
    "h100_80gb": {"label": "h100", "vram": "80GB", "best_for": "Largest models, longest contexts"},
